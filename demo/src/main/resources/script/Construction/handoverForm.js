...
async function loadProjHandoverTemplates(){
    ...
    .filter(template => template.name === "Project Handover Report")
    .forEach(template => {
    ...
    tile.onclick = () => renderProjHandoverForm(template);
    ...
    function renderProjHandoverForm(template){
